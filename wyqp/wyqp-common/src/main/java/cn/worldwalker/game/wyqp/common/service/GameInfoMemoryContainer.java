...
public class GameInfoMemoryContainer {
	...
	public static String createRoomFuse = Constant.createRoomFuseValue;
	...
	public static Map<String, String> dissolveIpRoomIdTimeMap = new ConcurrentHashMap<String, String>();
